...
class Test_Version_Helper extends Base_Test {
	...
	public function test_test_version( $result, $test_version, $min_version, $max_version ) {
		$this->assertEquals( $result, Version_Helper::test_version( $test_version, $min_version, $max_version ) );
	}
	...
	public function test_normalize_version( $result, $version, $return_number = false ) {
		$this->assertEquals( $result, Version_Helper::normalize_version( $version, $return_number ) );
	}
	...
	public function test_expand_version_number( $result, $version ) {
		$this->assertEquals( $result, Version_Helper::expand_version_number( $version ) );
	}
	...
	public function test_is_major_release( $result, $version ) {
		$this->assertEquals( $result, Version_Helper::is_major_release( $version ) );
	}
	...
	public function test_get_major_version( $result, $version ) {
		$this->assertEquals( $result, Version_Helper::get_major_version( $version ), true );
	}
}
