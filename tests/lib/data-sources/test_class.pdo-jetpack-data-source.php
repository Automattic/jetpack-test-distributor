...
class Test_PDO_Jetpack_Data_Source extends Base_Test {
	...
	public function test_get_completed_tests() {
			$data_source = $this->get_pdo_jetpack_data_source();
			$this->assertContains( '1', $data_source->get_completed_tests( 100 ) );
			$this->assertNotContains( '2', $data_source->get_completed_tests( 100 ) );
			$this->assertNotContains( '1', $data_source->get_completed_tests( 101 ) );
	}

	public function test_save_completed_test() {
			$data_source = $this->get_pdo_jetpack_data_source();
			$this->assertNotContains( '1', $data_source->get_completed_tests( 101 ) );
			$data_source->save_completed_test( '101', '1' );
			$this->assertContains( '1', $data_source->get_completed_tests( 101 ) );
	}
